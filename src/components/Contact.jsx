  ...
  const contactChannels = [
    {
      ...
      value: 'contact@adebaraahmad.dev',
      display: 'contact@adebaraahmad.dev',
      actionText: 'Send Email',
      href: 'mailto:contact@adebaraahmad.dev',
      icon: (
    ...
    },
    {
      ...
      value: '+234 (WhatsApp Direct)',
      display: 'Message on WhatsApp',
      actionText: 'Open Chat',
      href: 'https://wa.me/?text=Hello%20Adebara,%20I%20came%20across%20your%20portfolio',
      icon: (
        <svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
